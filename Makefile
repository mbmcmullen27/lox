clox: src/main.o src/memory.o src/chunk.o src/debug.o src/value.o src/vm.o src/scanner.o src/compiler.o
	clang src/main.o src/memory.o src/chunk.o src/debug.o src/value.o src/vm.o src/scanner.o src/compiler.o -o clox
